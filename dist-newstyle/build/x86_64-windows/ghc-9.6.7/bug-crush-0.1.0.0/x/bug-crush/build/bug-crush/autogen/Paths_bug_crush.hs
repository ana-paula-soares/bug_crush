...
-- at runtime using the environment variable bug_crush_bindir.
...
-- environment variable bug_crush_libdir.
...
-- using the environment variable bug_crush_dynlibdir.
...
-- runtime using the environment variable bug_crush_datadir.
...
-- using the environment variable bug_crush_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\bug-crush-0.1.0.0-inplace-bug-crush"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.6.7"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\bug-crush-0.1.0.0"
libexecdir = "C:\\cabal\\bug-crush-0.1.0.0-inplace-bug-crush\\x86_64-windows-ghc-9.6.7\\bug-crush-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "bug_crush_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "bug_crush_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "bug_crush_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "bug_crush_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "bug_crush_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "bug_crush_sysconfdir") (\_ -> return sysconfdir)
