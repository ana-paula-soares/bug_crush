...
/* package bug-crush-0.1.0.0 */
#ifndef VERSION_bug_crush
#define VERSION_bug_crush "0.1.0.0"
#endif /* VERSION_bug_crush */
#ifndef MIN_VERSION_bug_crush
#define MIN_VERSION_bug_crush(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bug_crush */
...
#define CURRENT_COMPONENT_ID "bug-crush-0.1.0.0-inplace-bug-crush"
